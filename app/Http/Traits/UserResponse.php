    ...
    public function userDataResponse($user , $token = null , $id = null)
    {
       ...
       else
       {
           $formate = [
                ...
                'dial_code' =>$user->dial_code,
                'id_number'=>$info->id_number,
                'nationality_id'=>$info->nationalities?$info->nationalities->id:null,
                'country_id'=>$info->countrys?$info->countrys->id:null,
                'region_id'=>$info->regions?$info->regions->id:null,
                'city_id'=>$info->citys?$info->citys->id:null,
                'country_code' =>$user->country_code,
                'email'=>$user->email,
                'phone'=>$user->phone,
                'gender'=>$info->gender,
