...
<div class="app-content content p-5 mt-5">
    ...
    <section id="basic-input">
        <div class="card p-5">
            ...
            @endif
        <form method="post" enctype="multipart/form-data" action="{{ route('dashboard.admins.update',$data->id) }}">
           @csrf
            <div class="form-row">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <select name="role" class="form-control" id="exampleFormControlSelect1">
                    ...
                    <option {{ $item->id == $data->roles[0]->id?'selected':'' }} value="{{ $item->id }}">{{ $item->name }}</option>                        
                    @endforeach
                </select>
              </div>
            </div>
