                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <fieldset class="form-group">
                                    ...
                                    <input id="title_en" value="{{ old('title_en')??$data->getTranslations('title')['en'] }}" type="text" class="form-control"  name="title_en" placeholder="Enter title" />
                                </fieldset>
                                <fieldset class="form-group">
                                    <label for="basicInput">Title AR</label>
                                    <input id="title_ar" value="{{ old('title_ar')??$data->getTranslations('title')['ar'] }}" type="text" class="form-control"  name="title_ar" placeholder="Enter name" />
                                </fieldset>
                                ...
                                <fieldset class="form-group">
                                    ...
                                    <textarea name="description_en" class="form-control">{{ old('description_en')??$data->getTranslations('description')['en'] }}</textarea>
                                </fieldset>
                                <fieldset class="form-group">
                                    <label for="basicInput">Description AR</label>
                                    <textarea name="description_ar" class="form-control">{{ old('description_ar')??$data->getTranslations('description')['ar'] }}</textarea>
                                </fieldset>
