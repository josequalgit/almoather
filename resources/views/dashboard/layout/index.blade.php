...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-sticky pace-done {{ isset($_COOKIE['collapsed']) && $_COOKIE['collapsed'] ? 'menu-collapsed' : 'menu-expanded'}}  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-left d-inline-block">2022 &copy; Al Muaathir</span><span class="float-right d-sm-inline-block d-none">Crafted with<i class="bx bxs-heart pink mx-50 font-small-3"></i>by<a class="text-uppercase" href="https://www.josequal.com/" target="_blank">Josequal</a></span>
