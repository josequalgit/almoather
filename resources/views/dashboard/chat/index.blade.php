                ...
                <div class="chat-sidebar card">
                    ...
                    <div class="chat-sidebar-search">
                        <div class="d-flex align-items-center">
                            <div class="chat-sidebar-profile-toggle">
                                <div class="avatar">
                                    <img src="" alt="user_avatar" height="36" width="36">
                                </div>
                            </div>
                    ...
                    <div class="chat-sidebar-list-wrapper">
                        ...
                        <ul class="chat-sidebar-list list-unstyled">
                            ...
                            <li onclick="get_active_user_messages('{{ $item->id }}')" class="d-flex align-items-center user-item">
                                <div class="avatar m-0 mr-50"><img onerror="this.onerror=null;this.src='https://timesaver247.com/wp-content/uploads/2020/10/default-user-image.png';"
                                    src="{{ $item->image['url'] }}" height="36" width="36" alt="sidebar user image">
...
<script>
    ...
    function get_active_user_messages(user_id)
    {
        ...
        oldUserId = user_id;
        channel = 'message.user-' + senToUser;
