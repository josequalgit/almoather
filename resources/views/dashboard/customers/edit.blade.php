                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <p class="mb-0">Customer: {{ $data->full_name }}</p>
                            </div>
                            <hr class="w-100">
                        </div>
                        <div class="card-body card-dashboard">
                            ...
                            <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row mb-2">
                                        <div class="form-group col-md-6">
                                            <img class="profileImage"
                                                src="{{ $data->users->image ? $data->users->image['url'] : null }}" />
                                        </div>
                                    </div>
                                @endif
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input disabled value="{{ old('first_name') ? old('first_name') : $data->first_name }}"
                                            name="first_name" type="full_name" class="form-control" id="inputfirst_name4"
                                            placeholder="first_name">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="inputPassword4">Middle Name</label>
                                        <input disabled value="{{ old('middle_name') ? old('middle_name') : $data->middle_name }}"
                                            name="middle_name" type="text" class="form-control" id="inputlast_name4"
                                            placeholder="last_name">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="inputPassword4">Last Name</label>
                                        <input disabled value="{{ old('last_name') ? old('last_name') : $data->last_name }}"
                                            name="last_name" type="text" class="form-control" id="inputlast_name4"
                                            placeholder="last_name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input disabled value="{{ old('phone') ? old('phone') : $data->phone }}" name="phone" type="text"
                                        class="form-control" id="inputAddress2" placeholder="phone">
                                </div>
                                <div class="form-group">
                                    <label for="inputAddress2">Id Number</label>
                                    <input disabled value="{{ old('id_number') ? old('id_number') : $data->id_number }}" name="id_number"
                                        type="text" class="form-control" id="inputAddress2" placeholder="id Number">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input disabled value="{{ old('country_id') ? old('country_id') : $data->countrys->name }}"
                                ...
                                <div class="form-group">
                                    ...
                                    @can('Edit Influncer')
                                        <button onclick="changeStatus()" type="button"
                                            class="mt-2 btn btn-primary float-right">Change</button>
                                    @endcan
                                </div>
                            </form>
                        </div>
