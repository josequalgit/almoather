    ...
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <input value="{{ old('nick_name') ? old('nick_name') : $data->nick_name }}" name="nick_name" type="text"
                class="form-control required" id="nick_name" name="nick_name" placeholder="nick_name">
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            ...
            <input value="{{ old('ad_price') ? old('ad_price') : $data->ad_price }}" name="ad_price" type="number" step="0.1"
                class="form-control required" id="ad_price" placeholder="ad_price">
        </div>
        ...
        <div class="form-group col-md-6">
            ...
            <input value="{{ old('ad_onsite_price') ? old('ad_onsite_price') : $data->ad_onsite_price }}" step="0.1"
                name="ad_onsite_price" type="text" class="form-control required" id="ad_onsite_price" placeholder="ad_onsite_price">
        </div>
        ...
        <div class="form-group col-md-6">
            ...
            <input value="{{ old('ad_with_vat') ? old('ad_with_vat') : $data->ad_with_vat }}" name="ad_with_vat"  step="0.1"
                type="text" class="form-control required" id="ad_with_vat" placeholder="ad_with_vat">
        </div>
