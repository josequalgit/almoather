            ...
            <div class="form-row mb-2">
                <div class="form-group col-md-6">
                    <img class="profileImage"
                        src="{{ $data->users->infulncerImage['url']}}" />
                </div>
            </div>
        @endif
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <input value="{{ old('first_name') ? old('first_name') : $data->first_name }}" name="first_name"
                    type="text" class="form-control" id="first-name" placeholder="First Name">
            </div>
            <div class="form-group col-md-6">
                <label for="first-name">Middle Name</label>
                <input value="{{ old('middle_name') ? old('middle_name') : $data->middle_name }}" name="middle_name"
                    type="text" class="form-control" id="middle-name" placeholder="Middle Name">
            </div>
            <div class="form-group col-md-6">
                <label for="first-name">Last Name</label>
                <input value="{{ old('last_name') ? old('last_name') : $data->last_name }}" name="last_name"
                    type="text" class="form-control" id="last-name" placeholder="Last Name">
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
                ...
                <input value="{{ old('id_number') ? old('id_number') : $data->id_number }}" name="id_number"
                    type="text" class="form-control" id="id_number" placeholder="birthday">
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
                ...
                <select name="region_id" id="region_id" class="form-control" data-value="{{ $data->region_id }}"></select>
            </div>
            <div class="form-group col-md-6">
                <label for="city_id">City</label>
                <select name="city_id" id="city_id" class="form-control" data-value="{{ $data->city_id }}"></select>
            </div>
            <div class="form-group col-md-6">
                <label for="email">Email</label>
                <input value="{{ old('email') ? old('email') : $data->users->email }}" name="email" type="text"
                    class="form-control" id="email" placeholder="email">
            </div>

            <div class="form-group col-md-6">
                <label for="phone">Phone</label>
                <input value="{{ old('phone') ? old('phone') : $data->users->phone }}" name="phone" type="text"
            ...
            <div class="form-group col-md-6">
                ...
                <input value="{{ old('ratting') ? old('ratting') : $data->ratting }}" name="ratting" type="text"
                    class="form-control" id="ratting" placeholder="ratting" min="0" max="5">
            </div>
