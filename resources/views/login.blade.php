            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  {{-- <span class="app-brand-text demo h3 fw-bold mb-0">Moather</span> --}}
                </a>
              </div>
              <!-- /Logo -->
              {{-- <h4 class="mb-2">Welcome to Moather! 👋</h4> --}}
              ...
              <form id="formAuthentication" class="mb-3" action="{{ route('loginSubmit') }}" method="POST">
                ...
                <div class="mb-3">
                  <button class="logButton btn btn-primary d-grid w-100" type="submit">Login</button>
                </div>
              </form>
