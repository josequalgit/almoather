                   ...
                   <div class="left-snapchat">
                    ...
                    <div class="container">
                        ...
                        <div class="row input-adv">
                            <div class="col-md-6 col-12  mt-3">
                                <input type="text" class="form-control" required placeholder="Nationality">
                            </div>
                            <div class="col-md-6 col-12  mt-3">
                        ...
                        <div class="row input-adv">
                            <div class="col-md-6 col-12  mt-3">
                                <input type="text" class="form-control" required placeholder="Region">
                            </div>
                            <div class="col-md-6 col-12  mt-3">
                                <select class="form-control" required name="" id="" >
                        ...
                        <div class="row input-adv">
                            ...
                            <div class="col-md-6 col-12 mt-3">
                                <input type="password" class="form-control" required placeholder="Re-Password">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-12 mt-3">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6 col-12 mt-3">
                                <div class="form-check input-adv p-0">
                                   <button class="btn btn-none form-control"  > Sing Up</button>
                                </div>
                            </div>
